...
//if more than one spike in train
			...
			//(in the case that more than one spike is within dt of the start/end
...
void run_TM(int *N1v,int *N2v,double *dtv,double *Time,double *index,double *spike_times_1,double *spike_times_2){
